...
public class SpringBootManyToOneWithCommandLineRunnerApplication implements CommandLineRunner {

	public static void main(String[] args) {
		SpringApplication.run(SpringBootManyToOneWithCommandLineRunnerApplication.class, args);
	}
