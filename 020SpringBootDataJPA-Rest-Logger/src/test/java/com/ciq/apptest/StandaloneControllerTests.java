...
public class StandaloneControllerTests {
  ...
  public void testfindAll() throws Exception {
    Product product1 = new Product(1L, "TV2", 200000.00);
    Product product2 = new Product(2L, "Laptop", 200000.00);
    Product product3 = new Product(3L, "Mobile", 200000.00);
  ...
  public void testfindById() throws Exception {
    Product product = new Product(1L, "TV2", 200000.00);
  ...
  public void testSave() throws Exception{
	  ...
	  Mockito.when(productService.save(any(Product.class))).thenReturn(new Product(1L, "Samsung TV", 100000.0));
